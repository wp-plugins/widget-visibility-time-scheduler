...
No. You set the visibility in each widget on the Widgets page in the backend.

= Does removing the plugin delete the settings in the database? =

Up to now: no. If you do not want any settings left in the database uncheck in each widget the visibility time scheduler before you remove the plugin.
